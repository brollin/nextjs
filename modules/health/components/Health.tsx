  ...
  <>
    ...
    <VStack as="article" width="100vw" justify="center" py={10} px={2}>
      <VStack maxWidth="40rem">
        ...
        <Image width={540} height={720} src="/images/amarillo_sunset.jpg" alt="Rock climbing" />
        <Text>
        ...
        <Text>
          In my young adulthood, I also began fire spinning and logged many hours doing so from 2014 onwards. Fire
          spinning (or specifically spinning poi, my prop of choice) involves moving one&apos;s arms around one&apos;s
          body for long periods of time. It can be a serious shoulder workout! Below is a video of some relatively calm
          spinning.
        </Text>
        <iframe
          width="560"
        ...
        <Heading as="h3">May 2020 - December 2020</Heading>
        <Text>TODO</Text>
      </VStack>
    </VStack>
  </>
